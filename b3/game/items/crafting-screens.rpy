            ...
            if i in known_recipes:
                ...
                button:
                    ...
                    if i not in seen_items:
                        add thisitem.image alpha .3 at zoomx(0.25)
                        # add thisitem.image + "2" alpha .3
                    else:
                        add thisitem.image at zoomx(0.25)
    ...
    vbox spacing 8:
        ...
        hbox:
            if whichitem.id in seen_items:
                add whichitem.image at zoomx(0.25)
            else:
                add whichitem.image alpha .3 at zoomx(0.25)
                # add whichitem.image alpha .3 at zoomx(1)
            spacing 20
                ...
                hbox:
                    ...
                    for i in whichitem.cost:
                        ...
                        button:
                            ...
                            if i not in seen_items:
                                add pr.image alpha .3 at zoomx(0.25)
                                # add pr.image + "2" alpha .3
                            else:
                                if inv.count(i) > 0:
                                    add pr.image at zoomx(0.25)
            ...
            hbox:
                ...
                hbox:
                    ...
                    if whichitem.id in seen_items:
                        ...
                        add whichitem.image alpha .3
                        # add whichitem.image + "2" alpha .3
                    fixed:
                        xsize 180
                        text _(" x [amount]") yalign .9

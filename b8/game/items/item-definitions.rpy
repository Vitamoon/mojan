...
define burnt_box = (_("Burnt Box"), "assetboxold", 50,
    _("This box is charred, slightly rusty, and has a broken lock."), "burnt_box")
...
define dying_will = (_("Unfinished Will"), "iconwill", 51,
    _("Found in your new flower shop."), "dying_will", ["burnt_box"])
    #yes I am aware it uses the wrong icon/asset tag it's on purpose

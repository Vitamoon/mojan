        ...
        grid invgrid_x invgrid_y:
            ...
            for item in collection[first:last]:
                ...
                button xysize itemslot_xysize:
                    ...
                    add set_item(item)[1] at zoomx(0.25) #shows item image

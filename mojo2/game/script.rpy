...
define jt = Character('[jt_name]', color="#de12cf")
...
label s6p2:
    ...
    scene bgjail
    show charyi 
    yw "Okay, that's everyone's alibis. I can attest to Shizhang and Luofei's being true, because there were newspaper articles about Shizhang running for city council, and Luofei winning a fishing contest on that day. We have to now see which people back each other up and who doesn't have someone supporting their alibi."
...
menu lol2:
    ...
    "Ask Yi" if not lol1:
        ...
        scene bgjail
        show charyi
        "Hmmm, think about the alibis again."
        jump lol2
...
label int6p0:
    ...
    if int5p1o1 and int5p1o2 and int5p1o3:
        jump s6p5
    else:
        jump int6p1

menu int6p1:
    "What do you mean by \"stuff?\"" if not int5p1o1:
        $ int5p1o1 = True
        b "To be honest, I don't really remember what I was doing that day. I'm sure I was in Zhen during my internship at the Zhen Post."
        jump int6p0

    "Why did you decide to work at the Zhen Post?" if not int5p1o2:
        $ int5p1o2 = True
        b "I would always watch the mailman go around delivering the mail, and I've always liked the idea of extending communications of the outside world to others. I like bringing people together."
        jump int6p0

    "How often do you visit the flower shop?" if not int5p1o3:
        $ int5p1o3 = True
        b "Weekly, to deliver the weekly newspaper, obviously."
        jump int6p0

label s6p5:
    scene bgjail
    show chardan
    "Wow, his answers are pretty solid. You'll have to ask more obscure and specific questions if you want to get answers."
    p "How long were you in the orphanage for?"
    b "As long as I can remember. I didn't know my biological parents."
    p "Did you know my aunt?"
    b "How is this relevant?"
    p "Answer the question."
    b "Well, yes. I saw her when I was delivering the newspaper."
    p "My aunt always told me how she would smack the paper boy with her broom because he would linger around  for too long. Was that you?"
    b "Yes..."
    p "And why were you lingering?"
    b "I, uh... I didn't like the vines growing all over the shop. I always wanted to clean them."
    p "And you successfully did so when she retired, huh."
    scene bgjail
    show charxiuqiu
    g "Aren't those vines the type that grow in the aftermath of fires?"
    "Everyone turns to look at Xiuqiu."
    scene bgjail
    show chardan
    b "Well yes, that's true, but I just didn't like how they looked."
    p "You could have asked my aunt to remove them."
    b "She didn't want to, which was so annoying. Something about preserving history, and the building being a grave for Jin Zi."
    p "You wanted to destroy something that symbolized the life and death of Jin Zi, just because you didn't like how it looked?"
    b "He didn't deserve a memorial."
    p "Why not? He owned an orphanage."
    b "That doesn't mean he was a good person."
    p "From what I've heard, he was a great person. What a saint."
    b "He was not! He was a murderer!"
    "It goes silent, all of the orphans staring at Dan. He started to visibly sweat."
    p "We've got a motive boys."
    b "No... You..."
    p "No I, what? You seem to be the only one who's aware of the fact that Jin Zi was a murderer, none of the rest of us knew this"
    b "Well..."
    p "So tell me, why exactly are you so convinced he's a bad person?"
    b "BECAUSE HE KILLED MY PARENTS! Ok? Because he killed my parents. That's how I know he isn't a good person"
    "It once again goes silent. No one seems to know if this is a lie or not. Everyone is looking at each other confused."
    b "I had to get revenge, alright?! There was no way that I could just let that monster live a peaceful life."
    p "And now we have a confession boys"
    b "I was justified in what I was doing! It was an eye for an eye. I bet he had lots of other shady stuff that he had done, I bet it was more than just one murder."
    "Upon hearing the confession, the guards in the prison spring to action and detain Dan. He struggles, but eventually passes out and gets dragged out of the room."
    "Huo gets let free once Dan is detained, and it's a happy reunion between her and her friends. You wonder if they'll be alright, but from the looks of it, they will. You briefly wonder what will happen to Dan, but that thought leaves as Yi pulls you along to go with the rest of the orphans" 
